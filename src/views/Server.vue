          ...
          <div class="card">
            <table class="table card-table table-vcenter">
              ...
              <tr class="d-flex">
                ...
                <td class="col-md-9 col-sm-8 col-xs-9 text-left">{{ $parent.serverData.server.onlineUsers }} user{{ $parent.serverData.server.onlineUsers > 1 ? 's' : ''}} / {{ $parent.serverData.server.clientCount }} client {{ $parent.serverData.server.clientCount > 1 ? 'instances' : 'instance'}}</td>
              </tr>
              <tr class="d-flex">
